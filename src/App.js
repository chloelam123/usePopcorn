...
function Search({ query, setQuery }) {
  //work with DOM elements, usually initial value is "null"
  //S1
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  // console.log(Object.values(watched).includes(movie.imdbID));
...
function WatchMoviesList({ watched, onDeletedWatched }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
        <WatchedMovie
